  ...
  Future _hapus(String id) async {
    try {
      final response = await http.post(
          Uri.parse(
              "http://localhost/pustaka_2301081006/proses_peminjaman.php?aksi=delete"),
          body: {
            "id": id,
          });
      if (response.statusCode == 200) {
                  ...
                  child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          ...
                          Container(
                            child: Text(
                                "Tanggal Pinjam : ${_listdata[index]['tanggal_pinjam']}"),
                          ),
                          Container(
                            child: Text(
                                "Tanggal Kembali : ${_listdata[index]['tanggal_kembali']}"),
                          ),
                        ],
                      ),
                      trailing: FittedBox(
